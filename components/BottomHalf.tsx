    ...
    <>     
       <div className="flex justify-left py-4">
               ...
               <p className="text-sm text-gray-700 mb-8">
                 ...
                 Registered with the information Commisioner's Office(ICO) - ICO Reg
                 No: ZA886741.
               </p>
               ...
               <p className="text-sm text-gray-700 mb-8">
                 *5,318.25 is the average claim as of 29/05/2024. *10,446.46 is the
                 most significant claim value as of 29/05/2024. *Based on industry
                 research; industry results may vary.
               </p>
               ...
               <p className="text-sm text-gray-700 mb-8">
                 ...
                 concerns, please review our Complaints Procedure.
               </p>
